...
public:
	...
	// adds a single debug line
	static void		addLine(const glm::vec3& v0, const glm::vec3& v1, const glm::vec4& color0, const glm::vec4& color1);

	// adds a triangle
	static void		addTri(const glm::vec3& v0, const glm::vec3& v1, const glm::vec3& v2, const glm::vec4& color);
	...
	static void		addAABB(const glm::vec3& center, const glm::vec3& extents, 
							const glm::vec4& color, const glm::mat4* transform = nullptr);
	...
	static void		addAABBFilled(const glm::vec3& center, const glm::vec3& extents, 
								  const glm::vec4& fillColor, const glm::mat4* transform = nullptr);
	...
	static void		addCylinderFilled(const glm::vec3& center, float radius, float halfLength,
									  unsigned int segments, const glm::vec4& fillColor, const glm::mat4* transform = nullptr);

	// adds a double-sided hollow ring in the XZ axis with optional transform for rotation.
	// if fillColor.w == 0 then only an outer and inner line is drawn
	...
	// if fillColor.w == 0 then only an outer line is drawn
	...
	static void		addSphere(const glm::vec3& center, float radius, int rows, int columns, const glm::vec4& fillColor, 
	...
	static void		addCapsule(const glm::vec3& center, float height, float radius,
							   int rows, int cols, const glm::vec4& fillColor, const glm::mat4* rotation = nullptr);
	...
	static void		add2DLine(const glm::vec2& start, const glm::vec2& end, const glm::vec4& color);
	static void		add2DLine(const glm::vec2& start, const glm::vec2& end, const glm::vec4& color0, const glm::vec4& color1);
	static void		add2DTri(const glm::vec2& v0, const glm::vec2& v1, const glm::vec2& v2, const glm::vec4& color);
	static void		add2DTri(const glm::vec2& v0, const glm::vec2& v1, const glm::vec2& v2, const glm::vec4& color0, const glm::vec4& color1, const glm::vec4& color2);
	static void		add2DAABB(const glm::vec2& center, const glm::vec2& extents, const glm::vec4& color, const glm::mat4* transform = nullptr);	
	static void		add2DAABBFilled(const glm::vec2& center, const glm::vec2& extents, const glm::vec4& color, const glm::mat4* transform = nullptr);	
	static void		add2DCircle(const glm::vec2& center, float radius, unsigned int segments, const glm::vec4& color, const glm::mat4* transform = nullptr);
