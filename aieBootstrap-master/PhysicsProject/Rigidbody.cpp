...
void Rigidbody::FixedUpdate(glm::vec2 a_gravity, float a_timeStep)
{
	...
	if (m_isTrigger)
	{
		// this will let usa check every object that is inside a trigger 
		// object and call TriggerEntered on if they  haven't registered 
		// inide the trigger inside this frame, they must, have exited 
		// so we can remove them from list and then call TriggerExit
